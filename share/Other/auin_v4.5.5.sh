...
function Script_Variable_init(){
    Version="ArchLinux User Install Scripts v4.5.5" 
...
function Install_Desktop_Env(){
    ...
    case ${DESKTOP_ID} in
        1)  Default_DM="sddm";    Install_Desktop plasma startkde      "$(Config_File_Manage CONF Read "PGK_Plasma")";;
        2)  Default_DM="gdm";     Install_Desktop gnome  gnome-session "$(Config_File_Manage CONF Read "PGK_Gnome")";;
        3)  Default_DM="lightdm"; Install_Desktop deepin startdde      "$(Config_File_Manage CONF Read "PGK_Deepin")";;
        4)  Default_DM="lightdm"; Install_Desktop xfce4  startxfce4    "$(Config_File_Manage CONF Read "PGK_Xfce4")";;
        5)  Default_DM="sddm";    Install_Desktop i3wm   i3            "$(Config_File_Manage CONF Read "PGK_I3wm")" ;;
        6)  Default_DM="lxdm";    Install_Desktop lxde   startlxde     "$(Config_File_Manage CONF Read "PGK_Lxde")" ;;
        7)  Default_DM="lightdm"; Install_Desktop cinnamon cinnamon-session "$(Config_File_Manage CONF Read "PGK_Cinnamon")";;
        8)  Default_DM="lightdm"; Install_Desktop mate   mate          "$(Config_File_Manage CONF Read "PGK_Mate")" ;;
        # 9)  Default_DM="sddm"; Install_Desktop "Plasma & Wayland"  ""  "$(Config_File_Manage CONF Read "P_plasma_Wayland")" ;;
...
function Installation_Desktop(){
    ...
    if [ -n "$INFO_UserName" ]; then 
        Install_Desktop_Env; #  安装桌面环境
        Install_Font;    #  安装字体
        Install_Fcitx;   #  安装Fcitx输入法
